...
**A6 — Shot alignment.** Weapons, bullets, muzzle flashes and impact sparks share one height above the ground. Mouse aiming inverts the projection on that same plane; screen shake and visual recoil stay out of the input transform. Shadows, Demo targeting rings, settled casings and fallen enemies remain on the floor. Actors and bullets draw in ground-depth order, while particles and airborne brass remain visible over the scene. The art does not enlarge collision circles or add headshots.

**A7 — Ejected casings.** Spent brass starts at the side of the gun's receiver, including its recoil offset. It spins sideways and upwards from weapon height, falls under cosmetic gravity, bounces once and settles. A ground shadow shows its height. Pausing freezes the arc; restarting clears the brass. The existing switch hides both flying and settled casings, while their motion continues when hidden. The 600-casing cap and separate visual randomness keep this effect bounded and independent of combat.

**A8 — Hunters and bodies.** Hunters wear red hunting coats and black top hats. Fallen enemies draws recognisable hunter and hound bodies on the floor, beneath living characters. Bodies have heads, limbs, clothing or fur, with a dropped hat and rifle beside each hunter. The effect retains the latest 100 deaths until restart; switching it off hides the bodies without discarding them. Bodies do not block movement, intercept bullets or change combat.
